        ...
        <div id="content" class="relative z-10 h-screen overflow-y-hidden lg:w-1/3">
            ...
            <section id="cover-section" class="relative z-10 h-screen w-full overflow-hidden">
                <div class="absolute flex h-full w-full items-center justify-start">
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/21.png" class="absolute inset-x-0 top-0 z-10 w-full" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/22.png" class="absolute inset-x-0 top-0 z-20 w-full" data-aos="fade-left" />

                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/23.png" class="absolute inset-x-0 z-20 w-full" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/24.png" class="absolute inset-x-0 z-10 w-full" data-aos="fade-left" />

                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/25.png" class="absolute inset-x-0 bottom-0 z-20 w-full" data-aos="fade-up" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/26.png" class="absolute inset-x-0 bottom-0 z-10 w-full" data-aos="fade-up" />
                </div>

                <div class="relative z-30 flex h-full w-full flex-col items-center justify-center">
                    <p class="mb-4 text-base font-semibold text-purple-400" data-aos="fade-down">
                    ...
                    <div class="mb-4 flex flex-col items-center justify-center">
                        <div class="absolute z-40 flex flex-col text-center" data-aos="zoom-in">
                            <p class="font-sacramento text-4xl font-semibold text-purple-400">
                        ...
                        <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/11.png" class="z-30 h-full w-full" data-aos="zoom-in" />
                    </div>

                    <div data-aos="fade-up" data-aos-offset="50">
                        <div class="rounded-lg border-2 border-purple-500 bg-white/75 p-2 text-center">
                        ...
                        <button onclick="openInvitation()" class="mx-auto mt-6 cursor-pointer rounded-full bg-purple-500 px-4 py-2 text-base text-white hover:bg-purple-600">
            ...
            <section id="quote-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                <div class="absolute flex h-full w-full items-center justify-start">
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/41.png" class="absolute inset-x-0 top-0 z-10 w-full" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/42.png" class="absolute inset-x-0 top-0 z-20 w-full" data-aos="fade-left" />

                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/43.png" class="absolute inset-x-0 bottom-0 z-20 w-full" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/44.png" class="absolute inset-x-0 bottom-0 z-10 w-full" data-aos="fade-left" />
                </div>

                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="fade-right">Quote</p>
                    @if ($invitation)
                        @if (! $invitation->quote)
                            <p class="rounded-lg bg-slate-500 px-4 py-2 text-white">Belum ada data.</p>
                        @else
                            <div class="px-2">
                                <div class="mb-4 text-justify text-base text-purple-400" data-aos="fade-right">
            ...
            <section id="wedding-couple-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="fade-down">Wedding Couple</p>
                        ...
                        @else
                            <div class="px-2">
                                ...
                                <div class="mb-4 flex items-center justify-start space-x-4" data-aos="fade-right">
                                    <img loading="lazy" src="{{ Storage::url($invitation->weddingCouple->bride_photo) }}" class="mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 border-purple-400 object-cover" />
                                    <div class="text-left">
                                        <p class="font-sacramento text-4xl font-semibold text-purple-400">
                                ...
                                <div data-aos="fade-left">
                                    ...
                                    <div class="mb-4 flex items-center justify-end space-x-4">
                                        ...
                                        <img loading="lazy" src="{{ Storage::url($invitation->weddingCouple->groom_photo) }}" class="mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 border-purple-400 object-cover" />
                                    </div>
                                </div>
                            </div>
                        @endif
                    @else
                        <div class="px-2">
                            ...
                            <div class="mb-4 flex items-center justify-start space-x-4" data-aos="fade-right">
                                <img loading="lazy" src="{{ asset("/") }}assets/images/wedding-couples/girl.jpg" class="mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 border-purple-400 object-cover" />
                                <div class="text-left">
                            ...
                            <div data-aos="fade-left">
                                ...
                                <div class="mb-4 flex items-center justify-end space-x-4">
                                    ...
                                    <img loading="lazy" src="{{ asset("/") }}assets/images/wedding-couples/boy.jpg" class="mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 border-purple-400 object-cover" />
                                </div>
                            </div>
                        </div>
                    @endif
            ...
            <section id="event-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="fade-right">Events</p>
                    ...
                    @if ($invitation)
                        ...
                        @else
                            ...
                            <div id="countdown" class="mb-4 flex justify-center gap-2" data-countdown="{{ $countdownDate }}" data-aos="fade-left">
                                <div class="w-15 rounded-lg border-2 border-purple-500 bg-white/75 p-2 text-center shadow-lg">
                            ...
                            @foreach ($invitation->events->sortBy("event_date") as $event)
                                <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                                    <p class="font-sacramento mb-2 text-4xl font-semibold text-purple-400">
                                        {{ $event->type }}
                                    </p>
                                    ...
                                    @if ($event->map_url)
                                        <a href="{{ $event->map_url }}" target="_blank">
                                            <button class="mx-auto mt-1 cursor-pointer rounded-full bg-purple-500 px-4 py-2 text-sm text-white hover:bg-purple-600">
                    ...
                    @else
                        ...
                        <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="font-sacramento mb-2 text-4xl font-semibold text-purple-400">Akad Nikah</p>
                        ...
                        <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-left">
                            <p class="font-sacramento mb-2 text-4xl font-semibold text-purple-400">Resepsi</p>
                            <p class="text-lg font-semibold">Minggu, 23 Oktober 2025</p>
                        ...
                        <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="font-sacramento mb-2 text-4xl font-semibold text-purple-400">Ngunduh Mantu</p>
                            <p class="text-lg font-semibold">Minggu, 23 Oktober 2025</p>
                            <p class="text-lg font-semibold">08:00 WIB</p>
            ...
            <section id="gallery-streaming-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="flip-left">Galleries</p>
                    ...
                    @if ($invitation)
                        @if ($invitation->streaming)
                            <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="flip-left">Streaming</p>
            ...
            <section id="love-story-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="fade-up">Love Stories</p>
                        ...
                        @else
                            @foreach ($invitation->loveStories->sortBy("order") as $loveStory)
                                <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-up">
                                    <p class="font-sacramento mb-4 text-center text-2xl font-semibold text-purple-400">
                                        {{ $loveStory->title }}
                                    </p>
                    ...
                    @else
                        <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-up">
                            <p class="font-sacramento mb-4 text-center text-2xl font-semibold text-purple-400">2023 (Lorem ipsum dolor sit amet)</p>
            ...
            <section id="message-gift-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="zoom-in">Messages</p>
                    <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                        <form id="message-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" placeholder="Masukkan nama Anda" class="w-full rounded-lg border border-purple-400 p-3 focus:ring-2 focus:ring-purple-400 focus:outline-none" />
                            </div>
                            <div class="mb-4">
                                <label for="message" class="mb-2 block text-left text-sm font-semibold text-gray-600">Pesan</label>
                                <textarea name="message" id="message" placeholder="Berikan ucapan serta doa restu Anda" class="w-full rounded-lg border border-purple-400 p-3 focus:ring-2 focus:ring-purple-400 focus:outline-none" rows="2"></textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4" id="guest_input" style="display: none">
                                ...
                                <input type="number" name="guest_total" id="guest_total" placeholder="Masukkan jumlah tamu (orang)" class="w-full rounded-lg border border-purple-400 p-3 focus:ring-2 focus:ring-purple-400 focus:outline-none" />
                            </div>
                            <button type="button" id="send-message-btn" class="mt-4 w-full cursor-pointer rounded-full bg-purple-500 p-2 text-base text-white hover:bg-purple-600">
                        ...
                        @if ($invitation)
                            <div id="messages" data-color="text-purple-400" class="mt-8 max-h-96 space-y-4 overflow-y-auto rounded-lg border border-gray-300 p-2"></div>
                        @else
                            <div class="mt-8 max-h-96 space-y-4 overflow-y-auto rounded-lg border border-gray-300 p-2">
                                ...
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-sm font-semibold text-purple-500">Nama Pengirim 1</p>
                                ...
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-sm font-semibold text-purple-500">Nama Pengirim 2</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-sm font-semibold text-purple-500">Nama Pengirim 3</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-sm font-semibold text-purple-500">Nama Pengirim 4</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-sm font-semibold text-purple-500">Nama Pengirim 5</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                            </div>
                        @endif
                    ...
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="zoom-in">Gift</p>
                    <div class="mb-4 w-full rounded-lg border-2 border-purple-400 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                        ...
                        <button id="open-modal" class="w-full cursor-pointer rounded-full bg-purple-500 p-2 text-base text-white hover:bg-purple-600">
                                    ...
                                    @if ($gift->type == "Rekening")
                                        <div class="relative mb-4">
                                            ...
                                            <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                                <p class="px-4 py-1 text-2xl font-semibold text-purple-400">
                                                    {{ $gift->account_name }}
                                                </p>
            ...
            <section id="closing-section" class="relative z-10 h-full w-full overflow-hidden">
                ...
                <div class="relative z-30 flex flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento mt-6 mb-4 px-2 text-center text-4xl font-semibold text-purple-400" data-aos="fade-down">Closing</p>
                    <div class="px-2">
                        <div class="mb-4 text-center">
                            <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/45.png" class="inset-x-0 z-20 mb-4 w-full" data-aos="fade-down" />
                            ...
                            <p class="font-sacramento mb-4 text-4xl font-semibold text-purple-400" data-aos="fade-up">
                                {{ $invitation->weddingCouple->bride_nickname ?? "Wanita" }}
                                &
                                {{ $invitation->weddingCouple->groom_nickname ?? "Pria" }}
                            </p>
                            <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/purple/46.png" class="inset-x-0 z-20 mb-4 w-full" data-aos="fade-up" />
                        </div>
                    </div>
                </div>
            </section>
