...
@section("content")
    ...
    <div class="bg-primary-brown-400 flex items-center justify-end">
        <!-- bottom footer -->
        ...
        <div id="content" class="relative z-10 h-screen overflow-y-hidden lg:w-1/3">
            ...
            <section id="cover-section" class="relative z-10 h-screen w-full overflow-hidden">
                <div class="absolute flex h-full w-full items-center justify-start">
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/41.png" class="absolute inset-x-0 top-0 z-10 w-full" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/42.png" class="absolute inset-x-0 top-0 z-20 w-full" data-aos="fade-left" />

                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/43.png" class="absolute inset-x-0 bottom-0 z-20 w-full" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/44.png" class="absolute inset-x-0 bottom-0 z-10 w-full" data-aos="fade-left" />
                </div>

                <div class="relative z-30 flex h-full w-full flex-col items-center justify-center">
                    <p class="text-primary-brown-400 mb-4 text-base font-semibold" data-aos="fade-down">
                    ...
                    <div class="mb-4 flex flex-col items-center justify-center">
                        <div class="absolute z-40 flex flex-col text-center" data-aos="zoom-in">
                            <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">
                                {{ $invitation->weddingCouple->bride_nickname ?? "Wanita" }}
                            </p>
                            <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">&</p>
                            <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">
                                {{ $invitation->weddingCouple->groom_nickname ?? "Pria" }}
                            </p>
                        </div>
                        <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/11.png" class="z-30 h-full w-full" data-aos="zoom-in" />
                    </div>

                    <div data-aos="fade-up" data-aos-offset="50">
                        <div class="border-primary-brown-500 rounded-lg border-2 bg-white/75 p-2 text-center">
                        ...
                        <button onclick="openInvitation()" class="bg-primary-brown-500 hover:bg-primary-brown-600 mx-auto mt-6 cursor-pointer rounded-full px-4 py-2 text-base text-white">
            ...
            <section id="quote-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="fade-right">Quote</p>
                    @if ($invitation)
                        @if (! $invitation->quote)
                            <p class="rounded-lg bg-slate-500 px-4 py-2 text-white">Belum ada data.</p>
                        @else
                            <div class="px-2">
                                <div class="text-primary-brown-400 mb-4 text-justify text-base" data-aos="fade-right">
            ...
            <section id="wedding-couple-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="fade-down">Wedding Couple</p>
                        ...
                        @else
                            <div class="px-2">
                                ...
                                <div class="mb-4 flex items-center justify-start space-x-4" data-aos="fade-right">
                                    <img loading="lazy" src="{{ Storage::url($invitation->weddingCouple->bride_photo) }}" class="border-primary-brown-400 mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 object-cover" />
                                    <div class="text-left">
                                        <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">
                                ...
                                <div data-aos="fade-left">
                                    ...
                                    <div class="mb-4 flex items-center justify-end space-x-4">
                                        ...
                                        <img loading="lazy" src="{{ Storage::url($invitation->weddingCouple->groom_photo) }}" class="border-primary-brown-400 mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 object-cover" />
                                    </div>
                                </div>
                            </div>
                        @endif
                    @else
                        <div class="px-2">
                            ...
                            <div class="mb-4 flex items-center justify-start space-x-4" data-aos="fade-right">
                                <img loading="lazy" src="{{ asset("/") }}assets/images/wedding-couples/girl.jpg" class="border-primary-brown-400 mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 object-cover" />
                                <div class="text-left">
                                    <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">Wanita</p>
                            ...
                            <div data-aos="fade-left">
                                ...
                                <div class="mb-4 flex items-center justify-end space-x-4">
                                    <div class="text-right">
                                        <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">Pria</p>
                                        <p class="text-base font-semibold text-gray-600">Nama Lengkap Pria</p>
                                        <p class="text-base text-gray-600">Putra ke 2 dari</p>
                                        <p class="text-base font-semibold text-gray-600">Bapak & Ibu</p>
                                    </div>
                                    <img loading="lazy" src="{{ asset("/") }}assets/images/wedding-couples/boy.jpg" class="border-primary-brown-400 mb-2 h-36 w-28 rounded-t-[30%] rounded-b-[30%] border-4 object-cover" />
                                </div>
                            </div>
                        </div>
                    @endif
            ...
            <section id="event-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="fade-right">Events</p>
                    ...
                    @if ($invitation)
                        ...
                        @else
                            ...
                            <div id="countdown" class="mb-4 flex justify-center gap-2" data-countdown="{{ $countdownDate }}" data-aos="fade-left">
                                <div class="border-primary-brown-500 w-15 rounded-lg border-2 bg-white/75 p-2 text-center shadow-lg">
                                    <span id="days" class="text-primary-brown-500 text-xl font-bold">00</span>
                                    <div class="text-sm text-gray-600">Hari</div>
                                </div>
                                <div class="border-primary-brown-500 w-15 rounded-lg border-2 bg-white/75 p-2 text-center shadow-lg">
                                    <span id="hours" class="text-primary-brown-500 text-xl font-bold">00</span>
                                    <div class="text-sm text-gray-600">Jam</div>
                                </div>
                                <div class="border-primary-brown-500 w-15 rounded-lg border-2 bg-white/75 p-2 text-center shadow-lg">
                                    <span id="minutes" class="text-primary-brown-500 text-xl font-bold">00</span>
                                    <div class="text-sm text-gray-600">Menit</div>
                                </div>
                                <div class="border-primary-brown-500 w-15 rounded-lg border-2 bg-white/75 p-2 text-center shadow-lg">
                                    <span id="seconds" class="text-primary-brown-500 text-xl font-bold">00</span>
                                    <div class="text-sm text-gray-600">Detik</div>
                                </div>
                            </div>

                            @foreach ($invitation->events->sortBy("event_date") as $event)
                                <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                                    <p class="font-sacramento text-primary-brown-400 mb-2 text-4xl font-semibold">
                                        {{ $event->type }}
                                    </p>
                                    ...
                                    @if ($event->map_url)
                                        <a href="{{ $event->map_url }}" target="_blank">
                                            <button class="bg-primary-brown-500 hover:bg-primary-brown-600 mx-auto mt-1 cursor-pointer rounded-full px-4 py-2 text-sm text-white">
                    ...
                    @else
                        ...
                        <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="font-sacramento text-primary-brown-400 mb-2 text-4xl font-semibold">Akad Nikah</p>
                        ...
                        <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-left">
                            <p class="font-sacramento text-primary-brown-400 mb-2 text-4xl font-semibold">Resepsi</p>
                            <p class="text-lg font-semibold">Minggu, 23 Oktober 2025</p>
                        ...
                        <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="font-sacramento text-primary-brown-400 mb-2 text-4xl font-semibold">Ngunduh Mantu</p>
                            <p class="text-lg font-semibold">Minggu, 23 Oktober 2025</p>
                            <p class="text-lg font-semibold">08:00 WIB</p>
            ...
            <section id="gallery-streaming-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="flip-left">Galleries</p>
                    ...
                    @if ($invitation)
                        @if ($invitation->streaming)
                            <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="flip-left">Streaming</p>
            ...
            <section id="love-story-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="fade-up">Love Stories</p>
                    ...
                    @if ($invitation)
                        ...
                        @else
                            @foreach ($invitation->loveStories->sortBy("order") as $loveStory)
                                <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-up">
                                    <p class="font-sacramento text-primary-brown-400 mb-4 text-center text-2xl font-semibold">
                                        {{ $loveStory->title }}
                                    </p>
                    ...
                    @else
                        <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-up">
                            <p class="font-sacramento text-primary-brown-400 mb-4 text-center text-2xl font-semibold">2023 (Lorem ipsum dolor sit amet)</p>
            ...
            <section id="message-gift-section" class="relative z-10 min-h-screen w-full overflow-hidden">
                ...
                <div class="relative z-30 flex min-h-screen w-full flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="zoom-in">Messages</p>
                    <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                        <form id="message-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" placeholder="Masukkan nama Anda" class="border-primary-brown-400 focus:ring-primary-brown-400 w-full rounded-lg border p-3 focus:ring-2 focus:outline-none" />
                            </div>
                            <div class="mb-4">
                                <label for="message" class="mb-2 block text-left text-sm font-semibold text-gray-600">Pesan</label>
                                <textarea name="message" id="message" placeholder="Berikan ucapan serta doa restu Anda" class="border-primary-brown-400 focus:ring-primary-brown-400 w-full rounded-lg border p-3 focus:ring-2 focus:outline-none" rows="2"></textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4" id="guest_input" style="display: none">
                                ...
                                <input type="number" name="guest_total" id="guest_total" placeholder="Masukkan jumlah tamu (orang)" class="border-primary-brown-400 focus:ring-primary-brown-400 w-full rounded-lg border p-3 focus:ring-2 focus:outline-none" />
                            </div>
                            <button type="button" id="send-message-btn" class="bg-primary-brown-500 hover:bg-primary-brown-600 mt-4 w-full cursor-pointer rounded-full p-2 text-base text-white">
                        ...
                        @if ($invitation)
                            <div id="messages" data-color="text-primary-brown-400" class="mt-8 max-h-96 space-y-4 overflow-y-auto rounded-lg border border-gray-300 p-2"></div>
                        @else
                            <div class="mt-8 max-h-96 space-y-4 overflow-y-auto rounded-lg border border-gray-300 p-2">
                                ...
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-primary-brown-500 text-sm font-semibold">Nama Pengirim 1</p>
                                ...
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-primary-brown-500 text-sm font-semibold">Nama Pengirim 2</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-primary-brown-500 text-sm font-semibold">Nama Pengirim 3</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-primary-brown-500 text-sm font-semibold">Nama Pengirim 4</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="rounded-md bg-green-100 p-4 shadow-md">
                                    <p class="text-primary-brown-500 text-sm font-semibold">Nama Pengirim 5</p>
                                    <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                            </div>
                        @endif
                    ...
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="zoom-in">Gift</p>
                    <div class="border-primary-brown-400 mb-4 w-full rounded-lg border-2 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                        ...
                        <button id="open-modal" class="bg-primary-brown-500 hover:bg-primary-brown-600 w-full cursor-pointer rounded-full p-2 text-base text-white">
            ...
            <div id="gift-modal" class="fixed inset-0 z-50 flex hidden justify-center py-4">
                ...
                <div class="relative mx-4 max-h-[90vh] w-full max-w-md overflow-hidden rounded-lg bg-white">
                    <div class="flex p-4">
                        <p class="font-sacramento text-primary-brown-400 text-4xl font-semibold">Gift</p>
                    ...
                    <div class="max-h-[70vh] overflow-y-auto px-4 pt-4 pb-8">
                                ...
                                @foreach ($invitation->gifts->sortBy("order") as $gift)
                                    @if ($gift->type == "Rekening")
                                        <div class="relative mb-4">
                                            <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/card-money.jpg" class="border-primary-brown-400 h-40 w-full rounded-3xl border-2 object-cover" />
                                            <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                                <p class="text-primary-brown-400 px-4 py-1 text-2xl font-semibold">
                                                    {{ $gift->account_name }}
                                                </p>
                                                <p class="px-4 py-1 text-2xl">
                                                    {{ $gift->account_number }}
                                                    <i id="copy-icosn" class="fa-regular fa-copy hover:text-primary-brown-400 cursor-pointer" onclick="copyToClipboard('bg-primary-brown-500', '{{ $gift->account_number }}')"></i>
                                                </p>
                                                <p class="px-4 py-1 text-2xl">
                                                    {{ $gift->account_holder }}
                                                </p>
                                    ...
                                    @elseif ($gift->type == "Paket")
                                        <div class="relative mb-4">
                                            <div class="border-primary-brown-400 flex rounded-3xl border-2 p-2">
                                                <div class="flex items-center px-4">
                                                    <i class="fas fa-gift text-primary-brown-400 text-3xl"></i>
                                                </div>
                                                <div class="flex flex-col justify-center">
                                                    ...
                                                    <p class="px-1 py-1 text-base">
                                                        ...
                                                        <i class="fa-regular fa-copy hover:text-primary-brown-400 cursor-pointer text-2xl" onclick='copyToClipboard("bg-primary-brown-500", "Name: {{ $gift->recipient_name }}, Phone Number: {{ $gift->recipient_phone_number }}, Address: {{ $gift->recipient_address }}")'></i>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @else
                            <div class="relative mb-4">
                                <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/card-money.jpg" class="border-primary-brown-400 h-40 w-full rounded-3xl border-2 object-cover" />
                                <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                    <p class="text-primary-brown-400 px-4 py-1 text-2xl font-semibold">BSI</p>
                                    <p class="px-4 py-1 text-2xl">
                                        1234567890
                                        <i id="copy-icosn" class="fa-regular fa-copy hover:text-primary-brown-400 cursor-pointer" onclick="copyToClipboard('bg-primary-brown-500', '1234567890')"></i>
                                    </p>
                                ...
                                <div class="border-primary-brown-400 flex rounded-3xl border-2 p-2">
                                    ...
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <p class="px-1 py-1 text-base">
                                            ...
                                            <i class="fa-regular fa-copy hover:text-primary-brown-400 cursor-pointer text-2xl" onclick='copyToClipboard("bg-primary-brown-500", "Name: Nama Penerima, Phone Number: 081234567890, Address: Lorem ipsum dolor sit amet consectetur Voluptas quaerat nulla velit.")'></i>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="closing-section" class="relative z-10 h-full w-full overflow-hidden">
                ...
                <div class="relative z-30 flex flex-col items-center justify-center px-4 py-8">
                    <p class="font-sacramento text-primary-brown-400 mt-6 mb-4 px-2 text-center text-4xl font-semibold" data-aos="fade-down">Closing</p>
                    <div class="px-2">
                        <div class="mb-4 text-center">
                            <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/45.png" class="inset-x-0 z-20 mb-4 w-full" data-aos="fade-down" />
                            ...
                            <p class="font-sacramento text-primary-brown-400 mb-4 text-4xl font-semibold" data-aos="fade-up">
                                {{ $invitation->weddingCouple->bride_nickname ?? "Wanita" }}
                                &
                                {{ $invitation->weddingCouple->groom_nickname ?? "Pria" }}
                            </p>
                            <img loading="lazy" src="{{ asset("/") }}assets/floral-template/images/brown/46.png" class="inset-x-0 z-20 mb-4 w-full" data-aos="fade-up" />
                        </div>
                    </div>
                </div>
            </section>
